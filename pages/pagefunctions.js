export function renderSeriesDetails(var_1, var_2, var_3, var_4, var_5, var_6a,var_6b,var_6c,var_6d,var_6e, var_7, var_8, var_9) {
    ...
    const contentHTML = `
            ...
            <p style="text-align: center;">
                <a href="#">
                    <button class="btn-sr" style="background:linear-gradient(135deg,#0ebac3,#09d261); color: white;"><i class="fa fa-download"></i> ⚡ G-Direct [Instant]</button>
                </a>
                <a href="#">
                    <button class="btn-sr" style="background:linear-gradient(135deg,#ed0b0b,#f2d152); color: white;"><i class="fa fa-download"></i> ⚡ V-Cloud [Resumable]</button>
                </a>
                <a href="#">
                    <button class="btn-sr" style="background: linear-gradient(135deg,#2ea1cf,#ff19d0); color: #fdf8f2;"> <i class="fa fa-file-zip-o" style="font-size:15px;color:#fff"></i> ⚡ Batch/Zip [2.8GB] </button>
                </a>
            </p>
            <!-- Leave it as it is -->
            ...
            <p style="text-align: center;">
                ...
                <a href="#">
                    <button class="btn-sr" style="background: linear-gradient(135deg,#2ea1cf,#ff19d0); color: #fdf8f2;"> <i class="fa fa-file-zip-o" style="font-size:15px;color:#fff"></i> ⚡ Batch/Zip [4.2GB] </button>
                </a>
            </p>
            <!-- Leave it as it is -->
            ...
            <p style="text-align: center;">
                ...
                <a href="#">
                    <button class="btn-sr" style="background: linear-gradient(135deg,#2ea1cf,#ff19d0); color: #fdf8f2;"> <i class="fa fa-file-zip-o" style="font-size:15px;color:#fff"></i> ⚡ Batch/Zip [9.8GB] </button>
                </a>
            </p>
            <!-- Leave it as it is -->
    `;
